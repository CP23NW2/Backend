...
<div class="absolute hidden w-full -ml-20 transition-all duration-300 bg-white rounded-lg opacity-0 md:inline-block top-5 focus:top-12 focus:opacity-100 focus:visible">
  <!-- เนื้อหาเมนูที่นี่ -->
    <div>
      ...
      <div class="items-center justify-between hidden w-full md:-mr-20 md:flex md:w-auto md:order-1 ">
          <ul class="flex flex-col items-center mt-4 border border-gray-100 rounded-lg peer bg-gray-50 md:flex-row md:space-x-4 md:mt-0 md:text-lg md:font-medium md:border-0 md:bg-white dark:bg-gray-800 dark:border-gray-700">
